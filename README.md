...
2. Download the [latest release](https://github.com/Navino16/flixpatrol-top10-on-trakt/releases/latest) corresponding to the platform where your want to run this tool
    ````shell
    wget https://github.com/Navino16/flixpatrol-top10-on-trakt/releases/download/v2.5.5/flixpatrol-top10-linux
    ````
...
| top10Config.type                   | Do you want movies, shows, both or overall list ?                                                                                                    | Yes       | movies, shows, both, overall                                                                                                                    | both                                         |
